...
public class bellman_algo {
	int d[],noofvertices;
	public bellman_algo(int noofvertices) 
	{
	...
	public static void main(String[] args) 
	{
		...
		source = s.nextInt();
		bellman_algo b = new bellman_algo(noofvertices);
		b.bellman_algo_eval(source,a);
		s.close();
	}
	
	private void bellman_algo_eval(int source, int[][] a) 
	{
